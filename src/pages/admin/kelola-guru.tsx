          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/10">
                ...
                <th className="px-4 py-3 text-left text-white font-semibold">NIP</th>
              ...
              {safeGuruList.length === 0 ? (
                ...
                safeGuruList.map((guru, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-white">{guru.nama_guru}</td>
                    <td className="px-4 py-3 text-white">{guru.email_guru}</td>
                    <td className="px-4 py-3 text-white font-mono">{maskPassword(guru.password_guru)}</td>
                    <td className="px-4 py-3 text-white">{guru.nip_guru}</td>
                    <td className="px-4 py-3 text-white">{guru.lembaga?.nama_lembaga || '-'}</td>
                    {!isValidated && (
  ...
  return (
    <div className="relative min-h-screen bg-[#0B0B1F] overflow-hidden">
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 border border-white/20 rounded-xl p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
            <h2 className="text-white text-2xl font-bold mb-6">Tambah Data Guru</h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-white mb-2">NIP</label>
                <input
                  type="text"
      ...
      {showEditModal && editingGuru && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 border border-white/20 rounded-xl p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
            <h2 className="text-white text-2xl font-bold mb-6">Identitas Guru</h2>
      ...
      <div className="relative pt-32 pb-12 px-6 max-w-7xl mx-auto">
        ...
        <div className="mb-8 bg-gray-900/50 backdrop-blur-md border border-white/10 rounded-xl p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <FaClock className="text-white text-2xl" />
              <h2 className="text-white text-xl font-semibold">Guru yang Belum diValidasi</h2>
            </div>
            <button
        ...
        <div className="bg-gray-900/50 backdrop-blur-md border border-white/10 rounded-xl p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-white text-xl font-semibold">Guru yang Sudah diValidasi</h2>
          </div>
